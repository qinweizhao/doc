...
#### 2、栈帧内部的组成结构 ![2022-03-31_192511](https://img.qinweizhao.com/2022/03/2022-03-31_192511.png)
...
![2022-03-31_192518](https://img.qinweizhao.com/2022/03/2022-03-31_192518.png)
...
Java 虚拟机的**解释引擎是基于栈的执行引擎**,其中的栈指的就是操作数栈。**结合操作数栈的概念来看一下一个方法（栈帧）的执行过程**
